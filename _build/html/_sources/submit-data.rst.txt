...
How to Sumbit Deployment Metadata
=================================

Depending on your project funding and other factors, you may need to submit pre-deployment metadata and post-deployment metadata. To do this, use the ATN Tag Deployment Metadata Template as described in the steps below.

.. note::

	You will need a `Research Workspace <https://researchworkspace.com/>`_ account to submit metadata. If you haven't created on yet, please see the `Creating & Accessing an Account <https://researchworkspace.com/help/CreatingAccountTutorial.html>`_ tutorial.
...
#. Fill in the first 5 columns (Columns A-F, which have a green background in the XLSX file) with information for each tag (one row per tag).
...
#. Fill in the remaining columns (F-P, shaded blue in the XLSX file) with deployment information (one row per tag).
#. Save the file somewhere easy to find on your computer.
#. Upload the completed file to the ``Data`` folder of your project in the Research Workspace.
